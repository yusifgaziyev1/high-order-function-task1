...
const getFindHeight = () => {
    let result = users.filter((a) => a.height > 150);
    console.log(result);
}

getFindHeight();

// 1) height in 190 den boyuk olanlari filterden isdifade ederek tapin

function getFindHeight2() {
    let result2 = users.filter((b) => b.height > 190);
    console.log(result2);
}
...
const getFindName = () => {
    let result = users.filter((name1) => name1.firstName == "Addison");
    console.log(result);
}
...
const getPlusAge = () => {
    let result = users.reduce((total, currency) => total + currency.age, 0);
    console.log(result);
}
...
const getFindWebDeveloper2 = () => {
    let result = users.filter((person) => person.company.title == "Web Developer");
    console.log(result);
}

getFindWebDeveloper2()